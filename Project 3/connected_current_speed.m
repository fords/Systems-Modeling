...
RMS_SC_CURRENT_Both = rms( Current_a_connected - current_L);
...
RMS_SC_W_both = rms( Theta - w_L*pi/180);
...
RMS_SC_val_current_both = rms(Current_a_connected_val - current_val_L);
...
RMS_SC_val_w_both = rms(Theta_val - w_val_L*pi/180);
