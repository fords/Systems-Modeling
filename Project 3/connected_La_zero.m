...
RMS_la0_CURRENT = rms( Current_a_connected - current_L)
...
RMS_la0_W = rms( Theta - w_L*pi/180)
...
RMS_la0_val_current = rms(Current_a_connected_val - current_val_L)
...
RMS_la0_val_w = rms(Theta_val - w_val_L*pi/180);
